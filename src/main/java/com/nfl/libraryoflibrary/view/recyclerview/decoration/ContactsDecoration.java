package com.nfl.libraryoflibrary.view.recyclerview.decoration;
...
import com.nfl.libraryoflibrary.beans.BaseIndexTagBean;
...
public class ContactsDecoration extends RecyclerView.ItemDecoration {
    ...
    public ContactsDecoration(Context context, List<? extends BaseIndexTagBean> datas) {
        super();
        mDatas = datas;
        mPaint = new Paint();
        mBounds = new Rect();
    ...
    public ContactsDecoration setmTitleHeight(int mTitleHeight) {
        this.mTitleHeight = mTitleHeight;
        return this;
    }


    public ContactsDecoration setColorTitleBg(int colorTitleBg) {
        COLOR_TITLE_BG = colorTitleBg;
        return this;
    }

    public ContactsDecoration setColorTitleFont(int colorTitleFont) {
        COLOR_TITLE_FONT = colorTitleFont;
        return this;
    }

    public ContactsDecoration setTitleFontSize(int mTitleFontSize) {
        mPaint.setTextSize(mTitleFontSize);
        return this;
    }

    public ContactsDecoration setmDatas(List<? extends BaseIndexTagBean> mDatas) {
        this.mDatas = mDatas;
        return this;
    }
