...
/**
 * Created by fuli.niu on 2016/7/15.
 */
...
public class CustomCircularImageView extends ImageView {
    ...
    private static final String TAG = CustomCircularImageView.class.getSimpleName();
    ...
    public CustomCircularImageView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (hasSelector && isSelected) { // Draw the selector stroke & apply the selector filter, if applicable
            ...
            // 将背景色设置为透明
//            int color = paintBorder.getColor() ;
...
//            Bitmap bitmap = BitmapFactory.decodeResource(getResources()  , R.drawable.icon_libuser_default) ;
//            Rect rectDefault = new Rect(0 + outerWidth / 2, 0 + outerWidth / 2, canvasSize - outerWidth / 2, canvasSize - outerWidth / 2) ;
//            canvas.drawBitmap(bitmap ,rectDefault , rekt , paintBorder);
